...
#define UAVCAN_EQUIPMENT_AIR_DATA_RAWAIRDATA_MAX_SIZE 56
#define UAVCAN_EQUIPMENT_AIR_DATA_RAWAIRDATA_SIGNATURE (0x1DD6A19CBBEFE7F7ULL)
...
struct uavcan_equipment_air_data_RawAirData {
    ...
    float total_pressure_sensor_temperature;
...
void _uavcan_equipment_air_data_RawAirData_encode(uint8_t* buffer, uint32_t* bit_ofs, struct uavcan_equipment_air_data_RawAirData* msg, bool tao) {
    ...
    *bit_ofs += 32;
    canardEncodeScalar(buffer, *bit_ofs, 32, &msg->total_pressure);
    *bit_ofs += 32;
    {
        uint16_t float16_val = canardConvertNativeFloatToFloat16(msg->total_pressure_sensor_temperature);
...
bool _uavcan_equipment_air_data_RawAirData_decode(const CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_equipment_air_data_RawAirData* msg, bool tao) {
    ...
    *bit_ofs += 32;
    ...
    canardDecodeScalar(transfer, *bit_ofs, 32, true, &msg->total_pressure);
    *bit_ofs += 32;

    {
        uint16_t float16_val;
        canardDecodeScalar(transfer, *bit_ofs, 16, true, &float16_val);
        msg->total_pressure_sensor_temperature = canardConvertFloat16ToNativeFloat(float16_val);
    }
    *bit_ofs += 16;
